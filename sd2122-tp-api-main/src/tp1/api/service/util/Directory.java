...
public interface Directory {
	 ...
	 * 
	 * @return OK if success + FileInfo representing the file. NOT_FOUND if the
	 *         userId does not exist. FORBIDDEN if the password is incorrect.
	 ...
	 * @param password - the password of the user.
	 * 
	 * @return OK if success; NOT_FOUND if the userId or filename does not exist.
	 ...
	 * @param password    - the password of the user.
	 * 
	 * @return OK if success; . NOT_FOUND if the userId or userIdShare or filename
	 *         does not exist. FORBIDDEN if the password is incorrect. BAD_REQUEST
	 *         otherwise.
	 */
	 ...
	 *         FORBIDDEN if the password is incorrect or the user cannot access the
	 *         file. BAD_REQUEST otherwise.
	 */
	 ...
	 * @param password - the password of the user.
	 * 
	 * @return OK if success + list of FileInfo; NOT_FOUND if the userId does not
	 *         exist. FORBIDDEN if the password is incorrect. BAD_REQUEST otherwise.
	 */
	Result<List<FileInfo>> lsFile(String userId, String password);

	/**
	 * Deletes all files of a given user, which is a necessary action for when a
	 * user is delete. If the user had no files to be deleted, the operation still
	 * succeeds.
	 * 
	 * @param userId   - id of the user.
	 * @param password - the password of the user.
	...
	/**
	 * Gets a file as a FileInfo object.
	 * 
	 * @param filename  - name of the file.
	 * @param userId    - id of the user.
	 * @param accUserId - id of the user executing the operation.
	 * @param password  - the password of accUserId.
	 *
	 * @return 200 if success + file; 404 if the userId or filename or accUserId
	 *         does not exist. 403 if the password is incorrect or the user cannot
	 *         access the file. 400 otherwise.
	 */
