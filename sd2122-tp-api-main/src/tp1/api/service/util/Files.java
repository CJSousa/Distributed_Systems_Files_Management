...
public interface Files {
	 ...
	 *
	 * @return OK if success. FORBIDDEN if the token is incorrect. BAD_REQUEST
	 *         otherwise.
	 */
	 ...
	 *               this will not be used).
	 * 
	 * @return OK if success; NOT_FOUND if the fileId does not exist. FORBIDDEN if
	 *         the token is incorrect. BAD_REQUEST otherwise.
	 */
	 ...
	 *         NOT_FOUND if the uniqueId does not exist. FORBIDDEN if the password
	 *         is incorrect. BAD_REQUEST otherwise.
	 */
