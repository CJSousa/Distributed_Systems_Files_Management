...
public interface RestDirectory {
	...
	FileInfo writeFile(@PathParam("filename") String filename, byte[] data, @PathParam("userId") String userId,
	...
	@DELETE
	@Path("/{userId}/{filename}")
	void deleteFile(@PathParam("filename") String filename, @PathParam("userId") String userId,
			@QueryParam("password") String password);
	...
	@Path("/{userId}/{filename}")
	@Produces(MediaType.APPLICATION_JSON)
	FileInfo findFile(@PathParam("filename") String filename, @PathParam("userId") String userId,
			@PathParam("accUserId") String accUserId, @QueryParam("password") String password);
